...
@section('konten')
    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row justify-content-between">
            ...
            <div class="mb-3">
                <label for="_nohp" class="form-label">Hp</label>
            ...
            <div class="col-5">
                ...
                <div class="mb-3">
                    <label for="_x" class="form-label">X</label>
                    <input type="text" class="form-control form-control-sm" name="_x" id="_x" value="{{ get_meta_value('_x') }}">
                </div>
                <div class="mb-3">
