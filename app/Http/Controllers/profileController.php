...
class profileController extends Controller
{
    ...
    function update(Request $request){
        $request->validate([
            ...
            '_foto.mimes' => 'Foto format JPG dan PNG',
        ...
        metadata::updateOrCreate(['meta_key'=>'_x'],
            ['meta_value'=>$request->_x]);
        metadata::updateOrCreate(['meta_key'=>'_linkedin'],
            ['meta_value'=>$request->_linkedin]);
        metadata::updateOrCreate(['meta_key'=>'_github'],
            ['meta_value'=>$request->_github]);

        return redirect()->route('profile.index')->with('success','Berhasil update foto');
    }
}
