...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            return redirect()->route('halaman.index')->with('success', 'Berhasil yah');
    }
    ...
    public function update(Request $request, string $id)
    {
        $request->validate(
            ...
            return redirect()->route('halaman.index')->with('success', 'Berhasil update yah');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Berhasil hapus yah');
    }
}