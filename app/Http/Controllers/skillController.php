    ...
    public function update(Request $request){
        if($request->method() == 'POST') {
            $request->validate([
                ...
                '_language.required' => 'silahkan masukkan bahasanya ya',
                '_workflow.required' => 'silahkan masukkan workflownya ya',
            ]);
            ...
            return redirect()->route('skill.index')->with('success', 'Berhasil update data skill ya');
        }
    }
}
