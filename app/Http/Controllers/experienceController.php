...
class experienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            return redirect()->route('experience.index')->with('success', 'Berhasil menambahkan experience yah');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Berhasil update yah');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Berhasil hapus experience yah');
    }
}
