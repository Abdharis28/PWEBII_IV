...
class educationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            return redirect()->route('education.index')->with('success', 'Berhasil menambahkan education yah');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Berhasil update yah');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Berhasil hapus education yah');
    }
}
